...
| 1.0.4    | 2025-07-15 | Gemini | Issue#8に伴う完了済みタスクの編集機能制限 |
| 1.0.5    | 2025-07-18 | Gemini | Issue#11に伴うフィルタリングUIのドロップダウン化 |
| 1.0.6    | 2025-07-18 | Gemini | Issue#19に伴う「完了タスクを一括削除」ボタンの表示制御 |
| 1.0.7    | 2025-07-19 | Gemini | Issue#17に伴うアクセシビリティ対応に関する記述を追加 |
| 1.0.8    | 2025-07-21 | Gemini | Issue#25に伴うHTML構造の修正 |
| 1.0.9    | 2025-07-23 | Gemini | 画面起動時の表示フィルタを「未完了」に修正 |
| 1.0.10   | 2025-07-30 | Gemini | Issue#22に伴う、祝日API取得失敗時のエラー通知に関する記述を追加 |
| 1.0.11   | 2025-07-31 | Gemini | Issue#13に伴う、祝日APIのキャッシュ機能に関する記述を更新 |
...
画面中央にあるフィルタリング用ドロップダウンリストを使用して、表示するタスクを絞り込むことができます。

*   **すべて:** 全てのタスクを表示します。
*   **未完了:** 未完了のタスクのみを表示します。（起動時のデフォルト）
...
本アプリケーションは、スクリーンリーダーの利用者が操作しやすいように設計されています。主要なボタンや入力フィールドには、その役割を説明するための`aria-label`が付与されており、視覚的な情報なしでも各機能を理解しやすくなっています。

## 8. よくある質問

**Q. 「祝日APIの取得に失敗しました」というアラートが表示されました。これは何ですか？**

A. このメッセージは、繰り返しタスクを自動生成する際に必要な日本の祝日情報を、外部のサーバーから取得できなかったことを示しています。これは、お使いのコンピュータがインターネットに接続されていない（オフライン）、または祝日情報を提供しているサーバーが一時的にダウンしている場合に発生する可能性があります。

このアラートが表示されても、アプリケーションの基本的な機能は引き続きご利用いただけます。一度でも祝日情報の取得に成功していれば、その情報がお使いのブラウザに保存（キャッシュ）されているため、オフラインでも祝日を考慮したタスク生成が可能です。ただし、長期間オフラインの場合や、一度もオンラインで利用したことがない場合は、祝日にもタスクが生成される可能性がありますのでご注意ください。